...
def main():
    ...
    # data_dir = tf.keras.utils.get_file('cars_train', origin=dataset_url, untar=True)
    data_dir = "/Users/ihorklimov/.keras/datasets/traffic_light_detection"
    data_dir = pathlib.Path(data_dir)
    print(data_dir)

    cars = list(data_dir.glob('car/*'))
    traffic_lights = list(data_dir.glob('traffic_lights/*'))
    img = PIL.Image.open(str(cars[0]))
